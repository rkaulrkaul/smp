...
class HeapTest {
	 ...
	 * Values used as priorities. Precondition: Values-priorities have to be in
	 * max-heap order.
	 */
	 ...
	 * Values used as priorities Precondition: Values-priorites have to be in
	 * min-heap order
	 */
	 ...
	 * Precondition: values-priorites have to be in max-heap order.
	 */
	 ...
	 * Precondition: values-priorities have to be in min-heap order.
	 */
	...
	@Test
	/**
	 * Test that inserting integers 0..59 into a heap, with priorities, same as
	 * values works. <br>
	 ...
	 * value being inserted is >= priorities of values in the heap, the inserted
	 * <br>
	...
	public void test40testDuplicatePriorities() {
		...
		// Check bubble down
		Heap<Integer> mh3 = maxHeapify(new Integer[] { 5, 6, 7 }, new double[] { 4.0, 4.0, 4.0 });
		mh3.poll();
		check(new Integer[] { 7, 6 }, new double[] { 4.0, 4.0 }, mh3);

		// Check bubble down
		Heap<Integer> mh4 = maxHeapify(new Integer[] { 5, 7, 6, 8 }, new double[] { 4.0, 4.0, 4.0, 4.0 });
		mh4.poll();
